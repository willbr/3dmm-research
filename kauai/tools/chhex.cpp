...
***************************************************************************/
DOCH::DOCH(PDocumentBase pdocb, PChunkyFile pcfl, ChunkTagOrType ctg, ChunkNumber cno) : DOCE(pdocb, pcfl, ctg, cno)
{
}
...
***************************************************************************/
PDOCH DOCH::PdochNew(PDocumentBase pdocb, PChunkyFile pcfl, ChunkTagOrType ctg, ChunkNumber cno)
{
    AssertPo(pdocb, 0);
    AssertPo(pcfl, 0);
