...
/* HRGN helpers (FCreateRgn / FreePhrgn / FUnionRgn / etc.) live in
 * regionwin.cpp now -- they're consumed by region.cpp which is in
 * kauai-core, so the helpers needed to move with it. */
